      ...
      <div className="max-w-4xl mx-auto text-gray-800 dark:text-gray-200">
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <p className="text-lg mb-6 text-gray-800 dark:text-gray-300">
            Outside of work, I tinker with robotics and explore cybersecurity as side interests — breaking and building things for fun. I also spend a lot of time in Valorant and League of Legends. If you&apos;re curious about my gaming profiles, try typing <span className="font-mono text-teal-800 dark:text-teal-400 font-medium">komiwalnut</span> on your keyboard. 🎮
          </p>
